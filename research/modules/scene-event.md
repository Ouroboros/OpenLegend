...
当前专项报告锁定 `research/inventory/scene-event-closure.tsv` 的 97 个函数，包括场景会话、六层绘制、物品目标适配、事件入口、KDEF 解释器、事件 helper、battle 入口和公共绘制/RNG helper。最终范围仍需与全局 ownership 人工对账。
