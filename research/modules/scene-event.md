...
97 行和后续 ownership 对账补入项全部关闭；任何 `pending_mapping`、`pending_implementation`、`implemented_pending_review` 或 remaining 非空都阻止 B7 完成。
