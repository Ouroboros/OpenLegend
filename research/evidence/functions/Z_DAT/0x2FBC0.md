...
- 按当前RANGER基线隔离单次执行，两处均由旧当前内力13、旧最大内力0得到新值300和gain287；原文字节为 `B5 EA A6 CB 20 A4 BA A4 4F BC 57 A5 5B 20 32 38 37 00`，帧FNV-1a64均为 `0xb372b65a000a1275`。
- 角色49面板为 `(70,40,180,27)`、文字位置 `(80,45)`，颜色5/7。
- 合成边界固定：最大32767、当前-32768、delta1回绕为-32768，gain0且无提示；最大-32768、当前-32768、delta-1回绕为32767并提示65535，帧 `0xb98021ea433f1e4d`；最大100、当前0、delta0仍提示100，帧 `0x7da5a3d67eae1b43`；最大100、当前100、delta-10写90且无提示。
- 两个可见合成帧串联SHA256 `fb174474df2b8a754d6e84b65570f05b67af30422cf394bb501c7b4639fc7c4a`。
