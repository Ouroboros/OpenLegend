...
- 按当前RANGER基线隔离单次执行，五次均产生提示：角色35由53到58，帧 `0x28e183a92b7be15c`；角色38由42到52，帧 `0xfa40828feea45365`；角色53由24到34，帧 `0x3e85437db9edb8c7`；角色49两次均由14到44，帧 `0x8c8c2dd6cf085323`。
- 六字节角色名使用面板 `(62,40,196,27)`和文字位置`(72,45)`；四字节角色名使用面板 `(70,40,180,27)`和文字位置`(80,45)`；颜色均为5/7。
- 合成边界固定：32767+1回绕负后钳0且无提示；-32768-1回绕正后钳100并提示32868，帧 `0xcce679be34f564ef`；-1+0钳0并提示1，帧 `0x583a21a959063fff`。两帧串联SHA256 `64f4dc023a3355247862eed25fae00a2b8c7544d1299939a173200d10dc886e8`。
