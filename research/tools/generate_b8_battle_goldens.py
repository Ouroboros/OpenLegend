...
def battle_cursor_handler_contract(z_dat_bytes: bytes) -> dict[str, object]:
    ...
    return {
        **contract,
        ...
        "input_state_transport": {
            "entry_clears_confirmation_keys": [0x0D, 0x20, 0x96],
            "entry_preserves_direction_and_escape": True,
            "direction_key_pairs": [
                [0x97, 0x98],
                [0x99, 0x9C],
                [0x9D, 0x9A],
            ...
            "direction_pair_cleared_before_move_test": True,
            "escape_key": 0x1B,
            "escape_state_cleared_before_exit": True,
            "confirmation_group_cleared_before_test": True,
            "nonzero_byte_state": True,
            "one_group_per_presented_scan": True,
        },
        "direction_rule":
...
def player_cursor_vectors(
    ...
    return {
        ...
        "presentation_gate": {
            ...
            "scan_after_successful_present": True,
        },
        "movement": {
