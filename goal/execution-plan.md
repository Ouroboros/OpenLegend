...
当前有效进度：`closure=279/349`，`unique_any=234/284`，`unique_all=219/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=45` queue enqueue
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=46` path write
