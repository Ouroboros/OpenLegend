...
当前有效进度：`closure=278/349`，`unique_any=233/284`，`unique_all=218/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=44` queue dequeue
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=45` queue enqueue
