...
当前有效进度：`closure=309/349`，`unique_any=264/284`，`unique_all=247/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=75` battle settlement
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=75` battle settlement
