...
当前有效进度：`closure=299/349`，`unique_any=254/284`，`unique_all=237/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=65` medicine action handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=66` medicine value kernel
