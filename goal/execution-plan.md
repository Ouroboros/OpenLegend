...
当前有效进度：`closure=298/349`，`unique_any=253/284`，`unique_all=236/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=64` medicine target wrapper
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=65` medicine action handler
