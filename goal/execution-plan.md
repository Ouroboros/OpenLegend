...
当前有效进度：`closure=334/349`，`unique_any=273/284`，`unique_all=269/284`
当前任务指针：input-font `research/inventory/input-font-closure.tsv` `audit_order=38` `sub_3D27A`
下一任务指针：input-font `research/inventory/input-font-closure.tsv` `audit_order=39` `sub_3DB83`
