...
当前有效进度：`closure=289/349`，`unique_any=244/284`，`unique_all=228/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=55` magic selection menu
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=56` HP damage kernel
