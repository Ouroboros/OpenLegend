...
当前有效进度：`closure=295/349`，`unique_any=250/284`，`unique_all=233/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=61` detox target wrapper
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=62` detox action handler
