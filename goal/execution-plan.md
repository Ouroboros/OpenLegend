...
当前有效进度：`closure=280/349`，`unique_any=235/284`，`unique_all=220/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=46` path write
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=47` path read
