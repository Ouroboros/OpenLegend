...
当前有效进度：`closure=285/349`，`unique_any=240/284`，`unique_all=224/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=51` player/AI attack, poison, medicine, detox and throwing FIGHT/EFT animation
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=52` throwing sample13 prelude and EFT animation
