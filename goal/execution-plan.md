...
当前有效进度：`closure=288/349`，`unique_any=243/284`，`unique_all=227/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=54` line attack area and direction pipeline
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=55` magic selection menu
