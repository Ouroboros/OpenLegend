...
当前有效进度：`closure=310/349`，`unique_any=265/284`，`unique_all=248/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=76` battle level up
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=76` battle level up
