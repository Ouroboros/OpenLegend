...
当前有效进度：`closure=311/349`，`unique_any=266/284`，`unique_all=249/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=77` battle practice
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=77` battle practice
