...
当前有效进度：`closure=302/349`，`unique_any=257/284`，`unique_all=240/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=68` throwing weapon action
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=69` rest actor action
