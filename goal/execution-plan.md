...
当前有效进度：`closure=287/349`，`unique_any=242/284`，`unique_all=226/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=53` damage animation and flash timeline
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=54` line attack area and direction pipeline
