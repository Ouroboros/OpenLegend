...
当前有效进度：`closure=294/349`，`unique_any=249/284`，`unique_all=232/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=60` poison value kernel
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=61` detox target wrapper
