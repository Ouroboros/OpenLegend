...
当前有效进度：`closure=301/349`，`unique_any=256/284`，`unique_all=239/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=67` player item selection wrapper
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=68` throwing weapon action
