...
当前有效进度：`closure=283/349`，`unique_any=238/284`，`unique_all=223/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=49` per-step movement
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=50` attack profile/area/animation/commit core
