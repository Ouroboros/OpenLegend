...
当前有效进度：`closure=261/349`，`unique_any=216/284`，`unique_all=202/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=27` AI用毒首个合格/陈旧距离目标
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=28` AI物品handler
