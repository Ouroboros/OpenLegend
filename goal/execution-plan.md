...
当前有效进度：`closure=286/349`，`unique_any=241/284`，`unique_all=225/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=52` throwing sample13 prelude and EFT animation
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=53` damage animation and flash timeline
