...
当前有效进度：`closure=262/349`，`unique_any=217/284`，`unique_all=203/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=28` AI物品handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=29` AI暗器handler
