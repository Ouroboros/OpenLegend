...
当前有效进度：`closure=297/349`，`unique_any=252/284`，`unique_all=235/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=63` detox value kernel
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=64` medicine target wrapper
