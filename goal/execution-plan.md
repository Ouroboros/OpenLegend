...
当前有效进度：`closure=291/349`，`unique_any=246/284`，`unique_all=229/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=57` MP damage kernel
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=58` poison-range kernel
