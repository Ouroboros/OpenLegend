...
当前有效进度：`closure=306/349`，`unique_any=261/284`，`unique_all=244/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=72` two-pass battle renderer
