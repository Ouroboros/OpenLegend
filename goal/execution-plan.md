...
当前有效进度：`closure=304/349`，`unique_any=259/284`，`unique_all=242/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=70` defer turn to end
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=71` enable automatic mode
