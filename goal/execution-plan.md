...
当前有效进度：`closure=292/349`，`unique_any=247/284`，`unique_all=230/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=58` poison-range kernel
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=59` poison action handler
