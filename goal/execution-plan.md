...
当前有效进度：`closure=308/349`，`unique_any=263/284`，`unique_all=246/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=74` battle outcome gate
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=74` battle outcome gate
