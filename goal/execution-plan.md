...
当前有效进度：`closure=282/349`，`unique_any=237/284`，`unique_all=222/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=48` shortest-path marking
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=49` per-step movement
