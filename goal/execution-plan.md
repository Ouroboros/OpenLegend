...
当前有效进度：`closure=315/349`，`unique_any=270/284`，`unique_all=253/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=81` status panel
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=81` status panel
