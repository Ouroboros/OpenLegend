...
当前有效进度：`closure=263/349`，`unique_any=218/284`，`unique_all=204/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=29` AI暗器handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=30` AI物品/暗器执行器
