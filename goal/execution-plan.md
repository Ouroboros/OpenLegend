...
当前有效进度：`closure=307/349`，`unique_any=262/284`，`unique_all=245/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=73` combatant sprite lookup
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=73` combatant sprite lookup
