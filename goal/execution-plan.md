...
当前有效进度：`closure=269/349`，`unique_any=224/284`，`unique_all=210/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=35` AI解毒handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=36` AI移动handler
