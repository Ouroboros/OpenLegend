...
当前有效进度：`closure=264/349`，`unique_any=219/284`，`unique_all=205/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=30` AI物品/暗器执行器
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=31` 敌方携带物品删除
