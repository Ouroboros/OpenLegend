...
当前有效进度：`closure=274/349`，`unique_any=229/284`，`unique_all=214/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=40` 目标寻路图handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=41` 移动阻挡图初始化
