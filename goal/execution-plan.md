...
当前有效进度：`closure=277/349`，`unique_any=232/284`，`unique_all=217/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=43` flood step
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=44` dequeue
