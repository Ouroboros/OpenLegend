...
当前有效进度：`closure=305/349`，`unique_any=260/284`，`unique_all=243/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=71` enable automatic mode
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=72` two-pass battle renderer
