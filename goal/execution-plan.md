...
当前有效进度：`closure=303/349`，`unique_any=258/284`，`unique_all=241/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=69` rest actor action
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=70` defer turn to end
