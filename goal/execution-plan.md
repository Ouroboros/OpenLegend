...
当前有效进度：`closure=316/349`，`unique_any=271/284`，`unique_all=253/284`
当前任务指针：input-font `research/inventory/input-font-closure.tsv` `audit_order=18` `sub_28E40`
下一任务指针：input-font `research/inventory/input-font-closure.tsv` `audit_order=19` `sub_2A0D9`
