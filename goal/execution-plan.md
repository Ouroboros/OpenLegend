...
当前有效进度：`closure=326/349`，`unique_any=273/284`，`unique_all=261/284`
当前任务指针：input-font `research/inventory/input-font-closure.tsv` `audit_order=30` `sub_30B81`
下一任务指针：input-font `research/inventory/input-font-closure.tsv` `audit_order=31` `sub_312A6`
