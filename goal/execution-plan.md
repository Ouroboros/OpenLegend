...
当前有效进度：`closure=293/349`，`unique_any=248/284`，`unique_all=231/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=59` poison action handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=60` poison value kernel
