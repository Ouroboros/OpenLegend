...
当前有效进度：`closure=271/349`，`unique_any=226/284`，`unique_all=212/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=37` 玩家移动handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=38` 通用战斗光标handler
