...
当前有效进度：`closure=312/349`，`unique_any=267/284`，`unique_all=250/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=78` battle crafting
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=78` battle crafting
