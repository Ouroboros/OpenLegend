...
当前有效进度：`closure=296/349`，`unique_any=251/284`，`unique_all=234/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=62` detox action handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=63` detox value kernel
