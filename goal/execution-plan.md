...
当前有效进度：`closure=270/349`，`unique_any=225/284`，`unique_all=211/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=36` AI移动handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=37` 玩家移动handler
