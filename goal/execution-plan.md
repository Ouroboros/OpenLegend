...
当前有效进度：`closure=268/349`，`unique_any=223/284`，`unique_all=209/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=34` AI医疗handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=35` AI解毒handler
