...
当前有效进度：`closure=333/349`，`unique_any=273/284`，`unique_all=268/284`
当前任务指针：input-font `research/inventory/input-font-closure.tsv` `audit_order=37` `sub_38DAC`
下一任务指针：input-font `research/inventory/input-font-closure.tsv` `audit_order=38` `sub_3D27A`
