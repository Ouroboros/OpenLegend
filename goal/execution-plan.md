...
当前有效进度：`closure=266/349`，`unique_any=221/284`，`unique_all=207/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=32` 请求医疗handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=33` 请求解毒共享入口
