...
当前有效进度：`closure=273/349`，`unique_any=228/284`，`unique_all=213/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=39` 移动寻路图handler
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=40` 目标寻路图handler
