...
当前有效进度：`closure=265/349`，`unique_any=220/284`，`unique_all=206/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=31` 敌方携带物品删除
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=32` 请求医疗handler
