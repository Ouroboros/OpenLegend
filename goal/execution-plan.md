...
当前有效进度：`closure=260/349`，`unique_any=215/284`，`unique_all=201/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=26` AI用毒最高攻击目标
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=27` AI用毒首个合格/陈旧距离目标
