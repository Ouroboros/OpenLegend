...
当前有效进度：`closure=275/349`，`unique_any=230/284`，`unique_all=215/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=41` 移动阻挡图初始化
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=42` 目标阻挡图初始化
