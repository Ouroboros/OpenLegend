...
当前有效进度：`closure=314/349`，`unique_any=269/284`，`unique_all=252/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=80` hidden target cleanup
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=80` hidden target cleanup
