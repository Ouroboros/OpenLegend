...
当前有效进度：`closure=281/349`，`unique_any=236/284`，`unique_all=221/284`
当前任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=47` path read
下一任务指针：B8 `research/inventory/battle-closure.tsv` `audit_order=48` shortest-path marking
